...
public class Game {
    ...
    private static HashMap<Integer, Field> createFields() {
        ...
        s.put(1, new Street("Oma Straße", 111 ,222, new int[]{333, 444, 555, 666}, 777, 23, 54, Color.rgb(112, 40, 0), 1));
        s.put(2, new GetCard(2));
        s.put(3, new Street("Braune Straße", 112 ,223, new int[]{334, 445, 556, 667}, 778, 12, 23,  Color.rgb(112, 40, 0), 3));
        s.put(4, new PayExtra(200, ExtraFields.SPOTIFY_PREMIUM, 4));
        s.put(5, new Station("Bahnhof", 200, 5));
        s.put(6, new Street("Aqua Straße", 113 ,224, new int[]{335, 446, 557, 668}, 779, 324, 2365, Color.AQUA, 6));
        s.put(7, new GetCard(GetCard.ChanceColors.GREEN, 7));
        s.put(8, new Street("Aqua Straße", 114 ,225, new int[]{336, 447, 558, 669}, 780, 64, 6543, Color.AQUA, 8));
        s.put(9, new Street("Aqua Straße", 115 ,226, new int[]{337, 448, 559, 670}, 781, 1234, 8976, Color.AQUA, 9));
        s.put(10, new Corner(CornerTyp.JAIL, 10));
        s.put(11, new Street("Purple Straße", 116 ,227, new int[]{338, 449, 560, 671}, 782, 34, 4, Color.PURPLE, 11));
        s.put(12, new PayExtra(200, ExtraFields.HESSLER_SCHULDEN, 12));
        s.put(13, new Street("Purple Straße", 117 ,228, new int[]{339, 450, 561, 672}, 783, 634, 756, Color.PURPLE, 13));
        s.put(14, new Street("Purple Straße", 118 ,229, new int[]{340, 451, 562, 673}, 784, 65437, 345, Color.PURPLE, 14));
        s.put(15, new Station("Bahnhof", 200, 15));
        s.put(16, new Street("Orang Straße", 119 ,230, new int[]{341, 452, 563, 674}, 785, 2344, 22, Color.ORANGE, 16));
        s.put(17, new Street("Orang Straße", 120 ,231, new int[]{342, 453, 564, 675}, 786, 222, 22, Color.ORANGE, 17));
        s.put(18, new GetCard(18));
        s.put(19, new Street("Orang Straße", 121 ,232, new int[]{343, 454, 565, 676}, 787, 99, 999, Color.ORANGE, 19));
        s.put(20, new Corner(CornerTyp.FREE_PARKING, 20));
        s.put(21, new Street("Red Straße", 122 ,233, new int[]{344, 455, 566, 677}, 788, 23423, 66, Color.RED, 21));
        s.put(22, new Street("Red Straße", 123 ,234, new int[]{345, 456, 567, 678}, 789, 345, 76546, Color.RED, 22));
        s.put(23, new GetCard(GetCard.ChanceColors.BLUE, 23));
        s.put(24, new Street("Red Straße", 124 ,235, new int[]{346, 457, 568, 679}, 790, 1234, 654, Color.RED, 24));
        s.put(25, new Station("Bahnhoff", 200, 25));
        s.put(26, new Street("Yellow Straße", 125 ,236, new int[]{347, 458, 569, 680}, 791, 874, 896, Color.YELLOW, 26));
        s.put(27, new Street("Yellow Straße", 126 ,237, new int[]{348, 459, 570, 681}, 792, 2444, 111, Color.YELLOW, 27));
        s.put(28, new PayExtra(200, ExtraFields.NAME_THREE, 28));
        s.put(29, new Street("Yellow Straße", 127 ,238, new int[]{349, 460, 571, 682}, 793, 2333, 44, Color.YELLOW, 29));
        s.put(30, new Corner(CornerTyp.GO_TO_JAIL, 30));
        s.put(31, new Street("LIME Straße", 128 ,239, new int[]{350, 461, 572, 683}, 794, 55, 898, Color.LIME, 31));
        s.put(32, new Street("LIME Straße", 129 ,240, new int[]{351, 462, 573, 684}, 795, 123, 44, Color.LIME, 32));
        s.put(33, new GetCard(33));
        s.put(34, new Street("LIME Straße", 130 ,241, new int[]{352, 463, 574, 685}, 796, 44, 6674, Color.LIME, 34));
        s.put(35, new Station("Bhanhoff", 200, 35));
        s.put(36, new GetCard(GetCard.ChanceColors.RED, 36));
        s.put(37, new Street("Dark Blue Straße", 131 ,242, new int[]{353, 464, 575, 686}, 797, 33, 67, Color.DARKBLUE, 37));
        s.put(38, new PayExtra(200, ExtraFields.NAME_FOUR, 38));
        s.put(39, new Street("Dark Blue Straße", 132 ,243, new int[]{354, 465, 576, 687}, 798, 43, 64, Color.DARKBLUE, 39));
